    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "dbc40bc6-0829-4ac5-a3ed-180f5e916a5f", 0, "0a23575c-bb01-4ba6-b0c6-43ff9bd19f11", "admina@strator.comx", false, false, null, null, null, "AQAAAAIAAYagAAAAEADCls+shn+zfKhWROkNbRWr1DinucZR2dyF417j2wz3B9fsCjOSmEjEg30JyWhSCg==", null, false, "ef99b357-7639-4412-8441-3c90c5812cc5", false, "Administrator" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 2, "Wash dishes" },
                    { 2, 7, 3, "Vacuum floors" },
                    { 3, 3, 1, "Take out trash" },
                    { 4, 5, 4, "Clean bathroom" },
                    { 5, 14, 5, "Mow the lawn" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2024, 5, 16, 10, 12, 56, 353, DateTimeKind.Local).AddTicks(1780), 1 });

            migrationBuilder.InsertData(
                table: "UserProfiles",
                columns: new[] { "Id", "Address", "Email", "FirstName", "IdentityUserId", "LastName", "UserName" },
                values: new object[] { 1, "101 Main Street", "admina@strator.comx", "Admina", "dbc40bc6-0829-4ac5-a3ed-180f5e916a5f", "Strator", "Boss" });
